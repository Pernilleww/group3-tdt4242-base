...
async function retrieveWorkout(id) {
    ...
    if (!response.ok) {
        ...
        if (workoutData.planned) {
            ...
            plannedDescription.className = plannedDescription.className.replace("hide", "");
        } else {
            loggedDescription = document.querySelector("#description-logged");
            loggedTitle = document.querySelector("#title-logged");

            loggedTitle.className = loggedTitle.className.replace("hide", "");
            loggedDescription.className = loggedDescription.className.replace("hide", "");
